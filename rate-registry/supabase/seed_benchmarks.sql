...
insert into public.benchmarks
  ...
  ('Kotak Mahindra','2026-09-10',5.25,NULL,NULL,7.60, NULL,10000,0.005,
   ...
   'Rate 7.60% CONFIRMED from the official Home Loan Interest Rates page (headline "From 7.60%* p.a."; salaried & self-employed 7.60% onwards) — resolves the earlier 7.60-vs-7.70 conflict. Floating is EBLR/repo-linked (hybrid = Repo + applicable spread; no numeric EBLR published). Fees from the Kotak GSFC referenced on that page: conversion 0.5% of POS cap Rs 10000 -> stored flat ~10000; PF 0.5%+taxes salaried (1% self-employed) + Rs 5000 login.'),
